...
describe('Kinvey.UserCollection', function() {
    ...
    var col;
    beforeEach(function() {
        col = new Kinvey.UserCollection();
    });

    // Kinvey.UserCollection.all()
    ...
    it('counts the number of users', function() {
        // Setup test
        var flag = null;
        waitsFor(function() {
            return null !== flag;
    ...
    // Kinvey.UserCollection.removeAll()
    it('is not allowed to delete all users', function() {
        expect(function() {
            col.removeAll()
        }).toThrow();
    });
