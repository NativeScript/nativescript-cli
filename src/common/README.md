...
```JavaScript
var common = require("mobile-cli-src");
...
Sample usage:
```JavaScript
var companionAppIdentifiers = require("mobile-cli-src").companionAppsService.getAllCompanionAppIdentifiers();
```
...
Sample usage:
```JavaScript
var companionAppIdentifiers = require("mobile-cli-src").companionAppsService.getCompanionAppIdentifier("cordova", "android");
```
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("deviceFound",  function(deviceInfoData) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("deviceLost",  function(deviceInfoData) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("deviceLogData",  function(identifier, reportedData) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("applicationInstalled",  function(identifier, applicationIdentifier) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("applicationUninstalled",  function(identifier, applicationIdentifier) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("debuggableAppFound",  function(applicationInfo) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("debuggableAppLost",  function(applicationInfo) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("companionAppInstalled",  function(identifier, framwework) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").deviceEmitter.on("companionAppUninstalled",  function(identifier, framwework) {
...
Sample usage:
```JavaScript
var devices = require("mobile-cli-src").devicesService.getDevices();
...
Sample usage:
```JavaScript
Promise.all(require("mobile-cli-src")
				.devicesService
...
```JavaScript
require("mobile-cli-src").devicesService.setLogLevel("FULL");
```
...
```JavaScript
require("mobile-cli-src").devicesService.setLogLevel("INFO", "129604ab96a4d0053023b4bf5b288cf34a9ed5fa");
```
...
Sample usage:
```JavaScript
require("mobile-cli-src").devicesService.mapAbstractToTcpPort("4df18f307d8a8f1b", "com.telerik.test", "Cordova")
	.then(function(port) {
		console.log(port);
	}, function(err) {
		console.log(err);
...
Sample usage:
```JavaScript
Promise.all(require("mobile-cli-src").devicesService.getDebuggableApps(["4df18f307d8a8f1b", "JJY5KBTW75TCHQUK"]))
	.then(function(data) {
...
Sample usage:
```JavaScript
require("mobile-cli-src").devicesService.getInstalledApplications("4df18f307d8a8f1b")
...
Promise.all(require("mobile-cli-src").liveSyncService.livesync(deviceInfos, projectDir))
	.then(function(result) {
...
Promise.all(require("mobile-cli-src").liveSyncService.livesync(deviceInfos, projectDir, filesToSync))
	.then(function(result) {
...
var filesToSync = [path.join(projectDir,"app","components", "homeView", "homeView.xml"),
					path.join(projectDir,"app","components", "addressView", "addressView.xml")]
Promise.all(require("mobile-cli-src").liveSyncService.deleteFiles(deviceInfos, projectDir, filesToSync))
	.then(function(result) {
...
require("mobile-cli-src").npmService.install("lodash@3.x", "D:\\test\\project", { save: true, "save-exact": true })
	.then(function(result) {
...
require("mobile-cli-src").npmService.install("D:\\test\\project", dependency)
	.then(function(result) {
			console.log("The npm result is: ", result);
	}).catch(function(err) {
			console.log("Error while installing packages from npm: ", err);
...
Sample usage:
```JavaScript
require("mobile-cli-src").npmService.uninstall("D:\\test\\project", "lodash")
	.then(function() {
