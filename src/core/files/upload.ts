...
async function saveFileMetadata(metadata, options: any = {}) {
...
async function uploadFile(url, file, metadata, options: any = {}) {
...
export default async function upload(file = {}, metadata: any = {}, options: any = {}) {
