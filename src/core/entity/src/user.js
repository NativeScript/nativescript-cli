...
import { KinveyError, NotFoundError, ActiveUserError } from 'common/errors';
import DataStore, { UserStore as store } from 'core/datastore';
import { Facebook, Google, LinkedIn, MobileIdentityConnect } from 'core/identity';
import { Log, isDefined } from 'common/utils';
