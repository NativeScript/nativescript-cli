...
describe('KinveyResponse', () => {
  describe('error', () => {
    ...
    it('should throw an APIVersionNotAvailableError', () => {//TODO: The APIVersionNotAvailableError is wrongly exported in the index.js of kinvey-errors as ApiVersionNotAvailableError
      const apiError = {
    ...
    it('should throw an APIVersionNotImplementedError', () => {//TODO: The APIVersionNotImplementedError is wrongly exported in the index.js of kinvey-errors as ApiVersionNotImplementedError
      const apiError = {
