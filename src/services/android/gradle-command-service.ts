import { IChildProcess, IErrors, IHostInfo, ISpawnFromEventOptions, ISpawnResult } from "../../common/declarations";
import { IGradleCommandOptions, IGradleCommandService } from "../../definitions/gradle";
