...
import { PackageInstallationManager } from "../src/package-installation-manager";
import { NodePackageManager } from "../src/node-package-manager";
import { YarnPackageManager } from "../src/yarn-package-manager";
import { PnpmPackageManager } from "../src/pnpm-package-manager";
import { FileSystem } from "../src/common/file-system";
import { ProjectData } from "../src/project-data";
import { ChildProcess } from "../src/common/child-process";
import { Options } from "../src/options";
import { CommandsService } from "../src/common/services/commands-service";
import { StaticConfig } from "../src/config";
import { HostInfo } from "../src/common/host-info";
import { Errors } from "../src/common/errors";
import { ProjectHelper } from "../src/common/project-helper";
...
import { ResourceLoader } from "../src/common/resource-loader";
import { PluginsService } from "../src/services/plugins-service";
import { AddPluginCommand } from "../src/commands/plugin/add-plugin";
import { MessagesService } from "../src/common/services/messages-service";
import { NodeModulesBuilder } from "../src/tools/node-modules/node-modules-builder";
...
import { PLUGINS_BUILD_DATA_FILENAME } from '../src/constants';
