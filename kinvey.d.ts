...
declare namespace Kinvey {
  ...
  function initialize(options: any): Promise<any>;
  class Client {}
  ...
  class NetworkStore {
    find(query?: Query, options?: {}): Observable<Array<{}>>;
    findById(id: string, options?: {}): Observable<{}>;
    group(aggregation: Aggregation, options?: {}): Observable<any>;
    count(query?: Query, options?: {}): Observable<number>;
  ...
  class User {
    ...
    static lookup(query?: Query, options?: {}): Observable<Array<{}>>;
