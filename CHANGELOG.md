...
* [Fixed #2644](https://github.com/NativeScript/nativescript-cli/issues/2644): Closing an app on an iOS device while run is on crashes with "Could not start application" message
