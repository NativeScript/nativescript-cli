...
var SyncError = function (_KinveyError) {
  _inherits(SyncError, _KinveyError);
  ...
  function SyncError() {
    ...
    return _possibleConstructorReturn(this, (SyncError.__proto__ || Object.getPrototypeOf(SyncError)).call(this, 'SyncError', message, debug, code));
  }
