...
const SDK_SRC_DIR = path.resolve(__dirname, '..', '..', 'packages', 'kinvey-node-sdk', 'src');
...
async function build() {
  ...
  const filteredFiles = files.filter((file) => {
    // Filter any file that contains a .node extension
    ...
    // An example could be *.nativescript.js which do not belong in the node build.
