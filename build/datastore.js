          ...
          return regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.prev = 0;
                  syncQuery = new _query5.Query().equalTo('collection', _this.collection);
                  cacheData = [];
                  networkData = [];
            ...
            while (1) {
              switch (_context2.prev = _context2.next) {
                ...
                case 5:
                  ...
                  syncQuery = new _query5.Query().equalTo('collection', _this2.collection);
                  _context2.next = 9;
            ...
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  ...
                  syncQuery = new _query5.Query().equalTo('collection', _this3.collection);
                  _context3.next = 5;
            ...
            while (1) {
              switch (_context6.prev = _context6.next) {
                ...
                case 9:
                  ...
                  _query = new _query5.Query().contains('entityId', Object.keys((0, _keyBy2.default)(localData, idAttribute)));
                  _context6.next = 16;
            ...
            while (1) {
              switch (_context7.prev = _context7.next) {
                ...
                case 22:
                  ...
                  _query3 = new _query5.Query().equalTo('entityId', data[idAttribute]);
                  _context7.next = 26;
    ...
    value: function clear(query) {
      ...
      var stream = _Observable.Observable.create(function () {
        var ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee8(observer) {
          var request, response, data, localData, _query4;
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                ...
                case 5:
                  ...
                  _query4 = new _query5.Query().contains('entityId', Object.keys((0, _keyBy2.default)(localData, idAttribute)));
                  _context8.next = 12;
                  return _this8.sync.clear(_query4, options);
          ...
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                ...
                if (!(query instanceof _query5.Query)) {
                  query = new _query5.Query((0, _result2.default)(query, 'toJSON', query)).equalTo('collection', this.collection);
                }
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                if (!(query instanceof _query5.Query)) {
                  query = new _query5.Query((0, _result2.default)(query, 'toJSON', query));
                }
