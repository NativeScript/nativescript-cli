...
describe("xcode-select-service", () => {
	...
	it("gets correct path to Developer directory on Mac OS X whitout whitespaces", async () => {
		...
		assert.deepStrictEqual(await service.getDeveloperDirectoryPath(), defaultXcodeSelectStdout, "xcode-select service should get correct trimmed  path to Developer directory on Mac OS X.");
	});
	...
	it("gets correct path to Developer directory on Mac OS X", async () => {
		...
		assert.deepStrictEqual(await service.getDeveloperDirectoryPath(), defaultXcodeSelectStdout, "xcode-select service should get correct path to Developer directory on Mac OS X.");
	});
	...
	it("gets correct path to Contents directory on Mac OS X", async () => {
		...
		assert.deepStrictEqual(await service.getContentsDirectoryPath(), expected, "xcode-select service should get correct path to Contents directory on Mac OS X.");
	});
	...
	it("stops execution when trying to get Developer directory if not on Mac OS X", async () => {
		...
		assert.deepStrictEqual(executionStopped, true, "xcode-select service should stop executon unless on Mac OS X.");
	});
	...
	it("stops execution when Developer directory is empty on Mac OS X", async () => {
		...
		assert.deepStrictEqual(executionStopped, true, "xcode-select service should stop executon when Developer directory is empty on Mac OS X.");
	});
	...
	it("stops execution when Contents directory is empty on Mac OS X", async () => {
		...
		assert.deepStrictEqual(executionStopped, true, "xcode-select service should stop executon when Contents directory is empty on Mac OS X.");
	});
});
