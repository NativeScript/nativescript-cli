  ...
  describe('init()', () => {
    ...
    describe('constructor', () => {
      it('should be able to create an instance', () => {
        const client = init();
        expect(client.apiHostname).to.equal('https://baas.kinvey.com');
        expect(client.micHostname).to.equal('https://auth.kinvey.com');
      });
      ...
      it('should be able to provide an masterSecret', () => {// TODO: the old SDK allows masterSecret use instead of appSecret. We are trying to discourage client from that, I know, but some may use it for testing purposes.
    ...
    describe('appVersion', function() {
      it('should set the appVersion', function() {//TODO: THis seems to be duplicate with a test above
        const appVersion = randomString();
    ...
    describe('defaultTimeout', function() {
      ...
      it(`should use ${defaultTimeout}ms when defaultTimeout is less than 0`, function() {//TODO: when the value for defaultTimeout is wrong, we should use the DEFAULT_VALUE
