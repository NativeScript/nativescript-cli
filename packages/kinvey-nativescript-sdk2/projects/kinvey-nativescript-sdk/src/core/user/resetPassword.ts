...
export default async function resetPassword(username, options: any = {}) {
  ...
  const request = new KinveyRequest({
    ...
    auth: Auth.App,
    url: formatKinveyUrl(apiProtocol, apiHost, `/${RPC_NAMESPACE}/${appKey}/${username}/user-password-reset-initiate`),
