...
import * as Kinvey from '/Users/thomasconner/Documents/Development/Kinvey/SDKs/JavaScript/packages/kinvey-html5-sdk/lib/index.js';
            ...
            try {
              ...
              deltaNetworkStore.save(entity3)
                .then(() => deltaStoreToTest.find(new Kinvey.Query(), { autoPagination: true })
                  .subscribe(anotherSpy, done, () => {
                    try {
                      utilities.validateReadResult(currentDataStoreType, anotherSpy, [entity1, entity2], [entity3], true);
                      done();
                    }
                    catch (error) {
                      done(error);
